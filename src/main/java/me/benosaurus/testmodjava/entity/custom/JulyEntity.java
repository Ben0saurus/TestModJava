...
public class JulyEntity extends AnimalEntity {

    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    public JulyEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.250, Ingredient.ofItems(Items.LILY_OF_THE_VALLEY), false));
        this.goalSelector.add(3, new FollowParentGoal(this, 1.10));

        this.goalSelector.add(4, new HoldInHandsGoal<>(this, new ItemStack(Items.LILY_OF_THE_VALLEY), null, entity -> true));
    ...
    public boolean isBreedingItem(ItemStack stack) {
        return stack.isOf(Items.LILY_OF_THE_VALLEY);
    }

    @Override
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.JULY.create(world, SpawnReason.BREEDING);
    }
}
